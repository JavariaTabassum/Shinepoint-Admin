...
const Message = () => {
  ...
  return (
    <div className="chat-box mx-auto bg-white rounded-lg font-poppins shadow-lg p-4">
      <style>
        {`
      ...
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-xl font-medium font-poppins">New Message</h1>
        <button
        ...
        {messages.map((msg) => (
          <div
            ...
            className={`flex items-center gap-3 p-3 mb-2 rounded-lg cursor-pointer ${
              msg.isActive ? "bg-[#CD44EF] text-white" : "hover:bg-gray-100"
            }`}
          >
