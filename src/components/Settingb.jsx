        ...
        <div className=" flex flex-col items-center font-poppins">
            ...
            <div className="w-full flex justify-between items-center px-1 py-4 dis4">
                ...
                <button className="bg-[#CD44EF] text-white py-2 px-2 w-[180px] rounded-lg flex items-center justify-center">
                    <span className="mr-4 text-xl" onClick={handleDashboardClick}><FontAwesomeIcon icon={faHouse} /></span> Dashboard
                </button>
            </div>
            ...
            <div className="flex flex-col md:flex-row w-11/12 min-w-full mt-3 gap-6">
                ...
                <div className=" w-[300px] bg-[#EFDAF4] rounded-lg p-6 h-[130px]">
                    <ul className="space-y-4 text-lg">
                        <li className="flex items-center space-x-3 text-[#CD44EF] font-semibold">
                            ...
                            <span className="cursor-pointer">Basic Information</span>
                        </li>
                        <li className="flex items-center space-x-3 text-[#6A6A6A]">
                            <span><img src={Key} alt="" /></span>
                            <span onClick={handleProfileClick} className="cursor-pointer">Password</span>
                        </li>
                    </ul>
                </div>
                ...
                <div className="w-full md:w-3/4  rounded-lg ">
                    ...
                    <form className="mt-8 bg-[#F4E3F9] p-6 rounded-lg shadow-lg border border-[#CD44EF]">
                        ...
                        {/* Full Name Field */}
                        <div className="mb-6 flex items-center gap-24 dis">
                            <label className=" text-md flex gap-3 items-center font-medium text-[#000000] mb-1 ">
                                Full Name <img src={QM} alt="" />
                            </label>
                            <div className="flex gap-3 dis3 flex-grow">
                                <input
                                    type="text"
                                    placeholder="First Name"
                                    className="flex-1 px-4 py-2 w-full border border-[#CD44EF] rounded-lg focus:ring-2 0 outline-none"
                                />
                                <input
                                    type="text"
                                    placeholder="Last Name"
                                    className="flex-1 px-4 py-2 w-full border border-[#CD44EF] rounded-lg focus:ring-2  outline-none"
                                />
                            </div>
                        </div>
                        <div className="mb-6 flex items-center gap-10 dis2" >
                            <label className="block text-md font-medium text-[#000000] mb-1">
                                Phone(Compulsory)
                            </label>
                                <input
                                    type="text"
                        ...
                        <div className="mb-6 flex items-center gap-[45px] dis2">
                            <label className="block text-md font-medium text-[#000000] mb-1">
                                Email(Compulsory)
                            </label>
                                <input
